...
export function Discovery({ currentUid, onLike, onPass }: any) {
  ...
  if (profiles.length === 0) return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "60vh", gap: 16, padding: 32 }}>
      <Volume2 size={48} color={T.txD} />
      <p style={{ color: T.txM, fontSize: 16, fontWeight: 700, textAlign: "center" }}>Plus de profils pour l'instant</p>
      <p style={{ color: T.txD, fontSize: 13, textAlign: "center" }}>Reviens plus tard, de nouveaux membres arrivent !</p>
    </div>
  );
  ...
  if (idx >= profiles.length) return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "60vh", gap: 16, padding: 32 }}>
      <Volume2 size={48} color={T.txD} />
      <p style={{ color: T.txM, fontSize: 16, fontWeight: 700, textAlign: "center" }}>Tu as vu tous les profils !</p>
      <p style={{ color: T.txD, fontSize: 13, textAlign: "center" }}>Reviens plus tard pour de nouveaux membres.</p>
    </div>
  );
